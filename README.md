...
**[Documentation](https://github.com/Prathmesh234/emu-driver)** - Installation, guides, and API reference.
...
```bash
claude mcp add --transport stdio emu-cua-driver -- emu-cua-driver mcp
```

If you want Claude Code's vision/computer-use-style flow to ground on EmuCuaDriver window screenshots, register the compatibility mode:
