    ...
    public static let screenshot = ToolHandler(
        ...
        invoke: { arguments in
            do {
                ...
                return errorResult(
                    "Screen Recording permission is not granted for EmuCuaDriver.")
            } catch {
