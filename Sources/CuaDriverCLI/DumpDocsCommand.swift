...
struct DumpDocsCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        discussion: """
            ...
            Examples:
              emu-cua-driver dump-docs                    # Output all docs
              emu-cua-driver dump-docs --type cli         # Output CLI docs only
              emu-cua-driver dump-docs --type mcp         # Output MCP tool docs only
              emu-cua-driver dump-docs --pretty           # Pretty-print output
            """
    )
